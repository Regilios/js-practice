...
console.log('biSafe      =', biSafe);
console.log('biSafe + 1n =', biSafe + 1 n);
console.log('biSafe + 2n =', biSafe + 2 n);
console.log();

console.log('15n / 3n =', 15 n / 3 n);
console.log('3n / 2n =', 3 n / 2 n);
console.log('BigInt(3n / 2n) =', BigInt(3 n / 2 n));
...
console.log('2n > 1n =', 2 n > 1 n);
console.log('2n > 1 =', 2 n > 1);
console.log();

console.log('(1000n ** 200n) / 12321n =', (1000 n ** 200 n) / 12321 n);
console.log();

const array2 = [3, -2, 7 n, -5 n, -1 n, 2, 5 n, 0];
console.log(array2);
console.log(array2.sort());
console.log();

const array1 = [-2, 7, 1 n, 3, -2 n, 8 n, 5, -4 n];
console.log(array1);
