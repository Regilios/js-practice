 ...
 *  theObj.returnFunction — это ссылка на функцию, но не вызов.
    ...
    ➡️ Проблема в том, когда и в каком контексте создаётся стрелочная функция.
    ...
    ➡️ А в случае theObj.returnFunction (без ()), создание стрелочной функции происходит не в theObj, а внутри doSayName, где this — undefined
 */
