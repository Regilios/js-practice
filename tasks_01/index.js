 ...
 * в JavaScript типизированные значения, а не типизированные переменные. Доступны следующие встроенные типы:
    ...
    когда мы вычеляем const view = new Int32Array(buffer); мы преобразуем блок памяти из ArrayBuffer в нужное числовое представление и после помещаем в него 42 -100
